  ...
  return (
    <div className="about-container">
      ...
      <div className="additional-info">
        ...
        <p>
          I created a gradient gradient shader which I preferred the appearance of. However, I realized that shader colors wouldn't update unless the page is refreshed which would be an issue for the director demographic view that I wanted to implement. Fortunately, I found a gradient material in the drei library and it looked exactly the same as the shader I created, so I used that instead since it didn't need to refresh to update the colors. I also added a GUI panel using a library called Leva and I was able to start testing the director demographic animation. Below is what the initial version looked like.
        </p>
        <img src="./images/iteration3.png" alt="Iteration 3" />
        <p>
          I continued to edit different features and adjust the visuals until I reached the final result which is what you see on the main page.
        </p>
